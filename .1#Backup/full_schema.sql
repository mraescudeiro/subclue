...
--
-- Name: parceiros Public read on premium slugs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Public read on premium slugs" ON public.parceiros FOR SELECT USING ((((plano)::text = 'PREMIUM'::text) AND (slug IS NOT NULL)));
