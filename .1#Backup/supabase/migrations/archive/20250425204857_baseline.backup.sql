...
/* ---------------------------------------------------------------
   ENUMs já criados pelo template do Supabase CLI
   ---------------------------------------------------------------
   Estes DO blocks garantem que o tipo só será criado se ainda não
   existir, evitando “type ... already exists” durante o reset.
---------------------------------------------------------------- */
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_type t
    JOIN pg_namespace n ON n.oid = t.typnamespace
    WHERE n.nspname = 'auth' AND t.typname = 'one_time_token_type'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_type t
    JOIN pg_namespace n ON n.oid = t.typnamespace
    WHERE n.nspname = 'realtime' AND t.typname = 'action'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_type t
    JOIN pg_namespace n ON n.oid = t.typnamespace
    WHERE n.nspname = 'realtime' AND t.typname = 'equality_op'
  ) THEN
...
/* ---------------------------------------------------------------
   Os tipos compostos (realtime.user_defined_filter, wal_column,
   wal_rls) NÃO existem no template do CLI → mantenha-os intactos.
---------------------------------------------------------------- */
...
CREATE OR REPLACE FUNCTION public.check_produto_image_limit() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: FUNCTION check_produto_image_limit(); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: assinantes; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN assinantes.stripe_customer_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
CREATE TABLE public.assinaturas (
    ...
    cancelado_no_fim_periodo boolean DEFAULT false NOT NULL,
    metadata jsonb,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT assinaturas_status_check CHECK ((status = ANY (ARRAY['trialing'::text, 'active'::text, 'past_due'::text, 'canceled'::text, 'incomplete'::text, 'incomplete_expired'::text, 'unpaid'::text])))
);
...
--
-- Name: TABLE assinaturas; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN assinaturas.status; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN assinaturas.stripe_subscription_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN assinaturas.data_inicio_ciclo; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN assinaturas.data_fim_ciclo; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN assinaturas.data_trial_fim; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN assinaturas.cancelado_no_fim_periodo; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: dispute_messages_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: dispute_messages_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE enderecos; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: featured_spot; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: parceiro_zonas_permitidas; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.parceiro_zonas_permitidas (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT parceiro_zonas_permitidas_tipo_zona_check CHECK ((tipo_zona = ANY (ARRAY['cep_range'::text, 'cidade'::text, 'estado'::text, 'pais'::text])))
);


ALTER TABLE public.parceiro_zonas_permitidas OWNER TO postgres;

--
-- Name: TABLE parceiro_zonas_permitidas; Type: COMMENT; Schema: public; Owner: postgres
--
...
CREATE TABLE public.parceiros (
    ...
    created_at timestamp with time zone DEFAULT now(),
    slug text,
    gerenciamento_frete text DEFAULT 'subclue'::text NOT NULL,
    custo_frete_proprio_cents integer,
    CONSTRAINT parceiros_custo_frete_proprio_cents_check CHECK ((custo_frete_proprio_cents >= 0)),
    CONSTRAINT parceiros_gerenciamento_frete_check CHECK ((gerenciamento_frete = ANY (ARRAY['subclue'::text, 'proprio'::text]))),
...
--
-- Name: COLUMN parceiros.gerenciamento_frete; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN parceiros.custo_frete_proprio_cents; Type: COMMENT; Schema: public; Owner: postgres
--
...
CREATE TABLE public.payouts (
    ...
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT payouts_status_check CHECK (((status)::text = ANY ((ARRAY['PAID'::character varying, 'PENDING'::character varying, 'FAILED'::character varying])::text[])))
);
...
CREATE TABLE public.periodos (
    ...
    CONSTRAINT periodos_periodicidade_check CHECK (((periodicidade)::text = ANY ((ARRAY['DIARIO'::character varying, 'SEMANAL'::character varying, 'MENSAL'::character varying, 'ANUAL'::character varying])::text[])))
);
...
--
-- Name: planos_parceiro; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: produto_atributo_valores; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.produto_atributo_valores OWNER TO postgres;

--
-- Name: produto_atributos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.produto_atributos OWNER TO postgres;
...
--
-- Name: produto_variantes; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN produtos.tipo_produto; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN produtos.peso_gramas; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN produtos.dimensoes_cm; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_parceiro; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_produto; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.transacoes (
    ...
    currency character(3) DEFAULT 'USD'::bpchar,
    created_at timestamp with time zone DEFAULT now(),
    valor_bruto_cents integer DEFAULT 0 NOT NULL,
    custo_envio_cents integer DEFAULT 0,
    taxa_processador_cents integer DEFAULT 0,
    comissao_subclue_cents integer DEFAULT 0,
    comissao_envio_subclue_cents integer DEFAULT 0,
    valor_liquido_parceiro_cents integer DEFAULT 0,
...
--
-- Name: COLUMN transacoes.assinatura_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN transacoes.valor_bruto_cents; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN transacoes.custo_envio_cents; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN transacoes.taxa_processador_cents; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN transacoes.comissao_subclue_cents; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN transacoes.comissao_envio_subclue_cents; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN transacoes.valor_liquido_parceiro_cents; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN transacoes.endereco_entrega_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: vw_planos_a_vencer; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vw_planos_a_vencer AS
...
--
-- Name: vw_ratings_parceiro; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vw_ratings_parceiro AS
...
--
-- Name: vw_ratings_produto; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vw_ratings_produto AS
...
--
-- Name: dispute_messages id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: assinantes assinantes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: assinantes assinantes_stripe_customer_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.assinantes
    ADD CONSTRAINT assinantes_stripe_customer_id_key UNIQUE (stripe_customer_id);


--
-- Name: assinantes assinantes_stripe_subscription_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: assinaturas assinaturas_stripe_subscription_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.assinaturas
    ADD CONSTRAINT assinaturas_stripe_subscription_id_key UNIQUE (stripe_subscription_id);
...
--
-- Name: featured_spot featured_spot_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: parceiro_zonas_permitidas parceiro_zonas_permitidas_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.parceiro_zonas_permitidas
    ADD CONSTRAINT parceiro_zonas_permitidas_pkey PRIMARY KEY (id);
...
--
-- Name: parceiros parceiros_stripe_account_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: planos_parceiro planos_parceiro_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: produto_atributo_valores produto_atributo_valores_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.produto_atributo_valores
    ADD CONSTRAINT produto_atributo_valores_pkey PRIMARY KEY (id);


--
-- Name: produto_atributos produto_atributos_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.produto_atributos
    ADD CONSTRAINT produto_atributos_pkey PRIMARY KEY (id);
...
--
-- Name: produto_variantes produto_variantes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: produto_variantes produto_variantes_sku_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.produto_variantes
    ADD CONSTRAINT produto_variantes_sku_key UNIQUE (sku);


--
-- Name: produto_variantes produto_variantes_stripe_price_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.produto_variantes
    ADD CONSTRAINT produto_variantes_stripe_price_id_key UNIQUE (stripe_price_id);
...
--
-- Name: reviews_parceiro reviews_parceiro_parceiro_id_assinante_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_parceiro reviews_parceiro_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_produto reviews_produto_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_produto reviews_produto_produto_id_assinante_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.variante_valores
    ADD CONSTRAINT variante_valores_pkey PRIMARY KEY (id);


--
-- Name: variante_valores variante_valores_variante_id_atributo_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.variante_valores
    ADD CONSTRAINT variante_valores_variante_id_atributo_id_key UNIQUE (variante_id, atributo_id);
...
--
-- Name: idx_assinantes_stripe_customer_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_assinantes_stripe_customer_id ON public.assinantes USING btree (stripe_customer_id);


--
-- Name: idx_assinaturas_assinante_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_assinaturas_assinante_id ON public.assinaturas USING btree (assinante_id);


--
-- Name: idx_assinaturas_plano_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_assinaturas_plano_id ON public.assinaturas USING btree (plano_id);
...
--
-- Name: idx_assinaturas_stripe_subscription_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_assinaturas_stripe_subscription_id ON public.assinaturas USING btree (stripe_subscription_id);


--
-- Name: idx_enderecos_assinante_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_enderecos_assinante_id ON public.enderecos USING btree (assinante_id);


--
-- Name: idx_parceiro_zonas_parceiro_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_parceiro_zonas_parceiro_id ON public.parceiro_zonas_permitidas USING btree (parceiro_id);


--
-- Name: idx_parceiro_zonas_tipo; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_parceiro_zonas_tipo ON public.parceiro_zonas_permitidas USING btree (tipo_zona, pais, estado, cidade);


--
-- Name: idx_produto_atributos_produto; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_produto_variantes_produto; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: parceiros_slug_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: planos_parceiro_fim_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: assinantes assinantes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: assinaturas assinaturas_assinante_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.assinaturas
    ADD CONSTRAINT assinaturas_assinante_id_fkey FOREIGN KEY (assinante_id) REFERENCES public.assinantes(id) ON DELETE CASCADE;


--
-- Name: assinaturas assinaturas_plano_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.assinaturas
    ADD CONSTRAINT assinaturas_plano_id_fkey FOREIGN KEY (plano_id) REFERENCES public.planos_produto(id);
...
--
-- Name: enderecos enderecos_assinante_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enderecos
    ADD CONSTRAINT enderecos_assinante_id_fkey FOREIGN KEY (assinante_id) REFERENCES public.assinantes(id) ON DELETE CASCADE;


--
-- Name: evidence_files evidence_files_dispute_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: featured_spot featured_spot_produto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: parceiro_zonas_permitidas parceiro_zonas_permitidas_parceiro_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.parceiro_zonas_permitidas
    ADD CONSTRAINT parceiro_zonas_permitidas_parceiro_id_fkey FOREIGN KEY (parceiro_id) REFERENCES public.parceiros(id) ON DELETE CASCADE;


--
-- Name: parceiros parceiros_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: payouts payouts_parceiro_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: periodos periodos_produto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: planos_parceiro planos_parceiro_parceiro_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: produto_atributo_valores produto_atributo_valores_atributo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.produto_atributo_valores
    ADD CONSTRAINT produto_atributo_valores_atributo_id_fkey FOREIGN KEY (atributo_id) REFERENCES public.produto_atributos(id) ON DELETE CASCADE;


--
-- Name: produto_atributos produto_atributos_produto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.produto_atributos
    ADD CONSTRAINT produto_atributos_produto_id_fkey FOREIGN KEY (produto_id) REFERENCES public.produtos(id) ON DELETE CASCADE;
...
--
-- Name: produto_variantes produto_variantes_produto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.produto_variantes
    ADD CONSTRAINT produto_variantes_produto_id_fkey FOREIGN KEY (produto_id) REFERENCES public.produtos(id) ON DELETE CASCADE;


--
-- Name: produtos produtos_parceiro_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_parceiro reviews_parceiro_assinante_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_parceiro reviews_parceiro_parceiro_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_produto reviews_produto_assinante_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_produto reviews_produto_produto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: transacoes transacoes_assinatura_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: transacoes transacoes_endereco_entrega_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transacoes
    ADD CONSTRAINT transacoes_endereco_entrega_id_fkey FOREIGN KEY (endereco_entrega_id) REFERENCES public.enderecos(id);


--
-- Name: variante_valores variante_valores_atributo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.variante_valores
    ADD CONSTRAINT variante_valores_atributo_id_fkey FOREIGN KEY (atributo_id) REFERENCES public.produto_atributos(id) ON DELETE CASCADE;


--
-- Name: variante_valores variante_valores_atributo_valor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.variante_valores
    ADD CONSTRAINT variante_valores_atributo_valor_id_fkey FOREIGN KEY (atributo_valor_id) REFERENCES public.produto_atributo_valores(id) ON DELETE CASCADE;


--
-- Name: variante_valores variante_valores_variante_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.variante_valores
    ADD CONSTRAINT variante_valores_variante_id_fkey FOREIGN KEY (variante_id) REFERENCES public.produto_variantes(id) ON DELETE CASCADE;
...
--
-- Name: reviews_parceiro Allow public select parceiro reviews; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_produto Allow public select produto reviews; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_parceiro Authenticated delete own parceiro review; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_produto Authenticated delete own produto review; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_parceiro Authenticated insert parceiro review; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_produto Authenticated insert produto review; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_parceiro Authenticated update own parceiro review; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_produto Authenticated update own produto review; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: assinantes; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.assinantes ENABLE ROW LEVEL SECURITY;

--
-- Name: assinantes customer_subs; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: parceiros; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.parceiros ENABLE ROW LEVEL SECURITY;

--
-- Name: parceiros partner_own; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: produtos partner_products; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_parceiro; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.reviews_parceiro ENABLE ROW LEVEL SECURITY;

--
-- Name: reviews_produto; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION check_produto_image_limit(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE assinantes; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE assinaturas; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE dispute_messages_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE evidence_files_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE featured_spot; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE parceiro_zonas_permitidas; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.parceiro_zonas_permitidas TO anon;
GRANT ALL ON TABLE public.parceiro_zonas_permitidas TO authenticated;
GRANT ALL ON TABLE public.parceiro_zonas_permitidas TO service_role;
...
--
-- Name: SEQUENCE periodos_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE planos_parceiro; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE produto_atributo_valores; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.produto_atributo_valores TO anon;
GRANT ALL ON TABLE public.produto_atributo_valores TO authenticated;
GRANT ALL ON TABLE public.produto_atributo_valores TO service_role;


--
-- Name: TABLE produto_atributos; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.produto_atributos TO anon;
GRANT ALL ON TABLE public.produto_atributos TO authenticated;
GRANT ALL ON TABLE public.produto_atributos TO service_role;
...
--
-- Name: TABLE produto_variantes; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE reviews_parceiro; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE reviews_produto; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE transacoes; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE transacoes_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON TABLE public.variante_valores TO anon;
GRANT ALL ON TABLE public.variante_valores TO authenticated;
GRANT ALL ON TABLE public.variante_valores TO service_role;


--
-- Name: TABLE vw_planos_a_vencer; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE vw_ratings_parceiro; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE vw_ratings_produto; Type: ACL; Schema: public; Owner: postgres
--
